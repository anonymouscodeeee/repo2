...
parser.add_argument(
    "-c", "--config", default="./3pc.json"
)
parser.add_argument(
    "-m", "--model_path", help="please input the path-to-flax-llama7b-EasyLM.msgpack",default="/data/gy/projects/open_llama_7b/llama_7b.msgpack"
)
parser.add_argument(
    "-t", "--tokenizer_path", help="please input the path-to-flax-llama7b-dir",default="/data/gy/projects/open_llama_7b"
)
...
def run_on_spu(token_num=9):
    ...
    for _ in range(token_num):
        ...
        with hack_softmax_context(
            ...
            _input_ids = ppd.device("P1")(lambda x: x)(smasheddata) # client
            _params = ppd.device("P2")(lambda x: x)(mid_params_dict) # server
